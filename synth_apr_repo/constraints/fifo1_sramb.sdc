...
set wclk_period 0.78
set rclk_period 0.78
...
set_output_delay -max -0.91 -clock rclk {rdata[*]}
set_output_delay -max -0.91 -clock rclk {rempty}
set_output_delay -max -0.91 -clock wclk {wfull}

set_output_delay -min -0.57 -clock rclk {rdata[*]}
set_output_delay -min -0.57 -clock rclk {rempty}
set_output_delay -min -0.57 -clock wclk {wfull}
